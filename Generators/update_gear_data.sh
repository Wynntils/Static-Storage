...
curl -X POST -d '{"type":["weapons","armour","accessories"]}' -H "Content-Type: application/json" -o gear.json.tmp "https://api.wynncraft.com/v3-dev/item/search?fullResult=True"
